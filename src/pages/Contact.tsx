              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">info@bookhaven.com</p>
                    <p className="text-gray-600 dark:text-gray-300">support@bookhaven.com</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-semibold text-lg transition-colors duration-200 group"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                answer: "We accept returns within 30 days of purchase in original condition. Return shipping is free for defective items."
              },
              {
              ...
              },
              {
                ...
                answer: "Orders can be cancelled within 1 hour of placement. After processing begins, cancellation may not be possible."
              }
            ].map((faq, index) => (
